...
final class InternalDataSync
{
	...
	/**
	 * Whether an OWC internal-data host (Fusion PDC / OpenPub) is present, used
	 * as the default for the `enable-internal-data-sync` filter so sites without
	 * those plugins don't get the owner mirrored into fields nothing reads.
	 */
