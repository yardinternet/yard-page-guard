...
?>
			...
			<tr valign="top">
				...
				<td>
					<input type="text" name="ypg_review_email_subject" value="<?= esc_attr(get_option('ypg_review_email_subject', __('Houdbaarheidscontrole', 'yard-page-guard'))); ?>" />
				</td>
			</tr>
			<tr valign="top">
...
?>
			...
			<tr valign="top">
				...
				<td>
					<input type="text" name="ypg_reminder_email_subject" value="<?= esc_attr(get_option('ypg_reminder_email_subject', __('Controle herinnering', 'yard-page-guard'))); ?>" />
				</td>
			</tr>
			<tr valign="top">
