...
class Plugin
{
	...
	/**
	 * Get dependencies and version generated by the build
	 */
	public function assetMeta(string $entry): array
	{
		$path = $this->resourcePath("{$entry}.asset.php");
		$asset = is_readable($path) ? require $path : [];
